                  ...
                  <div className="space-y-4">
                    {dashboardData.top_regions.map((region: any, index: number) => (
                      <div key={index} className="space-y-2">
                        ...
                        <Progress 
                          value={(region.disposal_count / Math.max(...dashboardData.top_regions.map((r: any) => r.disposal_count))) * 100} 
                          className="h-2" 
                        />
                      </div>
                    ))}
          ...
          <TabsContent value="users" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <Card className="shadow-card-eco border-0 lg:col-span-2">
                ...
                <CardContent>
                  <div className="space-y-3">
                    {usersOverview.disposal_frequency.slice(0, 8).map((user: any, index: number) => (
                      <div key={index} className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                        <div className="flex items-center space-x-3">
                ...
                <CardContent>
                  <div className="h-80">
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        <Pie
                          data={wasteAnalysis.waste_trends.map((item: any, index: number) => ({
                          ...
                          dataKey="value"
                        >
                          {wasteAnalysis.waste_trends.map((entry: any, index: number) => (
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    {wasteAnalysis.waste_trends.slice(0, 4).map((waste: any, index: number) => (
          ...
          <TabsContent value="bins" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <Card className="shadow-card-eco border-0">
                ...
                <CardContent>
                  <div className="space-y-3">
                    {binStatus.capacity_distribution.map((capacity: any, index: number) => (
              ...
              <Card className="shadow-card-eco border-0">
                ...
                <CardContent>
                  <div className="space-y-3">
                    {binStatus.bins_needing_attention.slice(0, 5).map((bin: any, index: number) => (
              ...
              <Card className="shadow-card-eco border-0">
                ...
                <CardContent>
                  <div className="space-y-3">
                    {binStatus.underutilized_bins.slice(0, 5).map((bin: any, index: number) => (
                      <div key={index} className="p-3 bg-muted/50 rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          <span className="font-medium text-sm">{bin.location_name}</span>
